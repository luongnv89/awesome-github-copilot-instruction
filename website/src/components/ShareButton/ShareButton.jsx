...
const ShareButton = ({ url, text = 'Share', content, title }) => {
  ...
  const generateShareContent = () => {
    const defaultContent = "Check out GitHub Copilot Instructions - A curated collection of custom instructions for GitHub Copilot!";
  ...
  const shareOptions = [
    ...
    },
    {
      name: 'Email',
      icon: <FiMail />,
      url: `mailto:?subject=${encodeURIComponent(title || 'Check out this GitHub Copilot instruction!')}&body=${generateShareContent()}`,
